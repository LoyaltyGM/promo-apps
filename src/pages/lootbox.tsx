...
// Our components
import { CustomDialog, Sidebar, CircleLoaderButton } from "components";
...
const Lootbox: NextPage = () => {
    ...
    useEffectOnce(() => {
        async function fetchTotalOpened() {
            try {
                const collectionObject = await provider.getObject(LOOTBOX_COLLECTION);
                const collection = getObjectFields(collectionObject);
